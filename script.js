...
function setAnotherDaysToBeDownOnTheScreen(date) {
  switch (date) {
    ...
    case "Tue":
      ...
      sun.style.top = mon.style.top = "83px";
      break;
    case "Wed":
      resetPositions();
      sun.style.position = mon.style.position = tue.style.position = "relative";
      sun.style.top = mon.style.top = tue.style.top = "83px";
      break;
    case "Thu":
      resetPositions();
      sun.style.position =
        ...
        wed.style.position =
          "relative";
      sun.style.top = mon.style.top = tue.style.top = wed.style.top = "83px";
      break;
    case "Fri":
      resetPositions();
      sun.style.position =
...
function getWeekDay(day) {
  switch (day) {
    ...
    case "Tue":
      ...
      break;
    case "Wed":
      el = document.querySelector(".wed-container");
      break;
    case "Thu":
      el = document.querySelector(".thu-container");
      break;
    case "Fri":
